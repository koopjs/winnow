...
Winnow.query = function (input, options = {}) {
  ...
  if (options.classificationDef) return breaksQuery(features, query, options) // // TODO: use winnow.querySql for UniqueValue --> I'll have to do something for slect distinct 'field' from
